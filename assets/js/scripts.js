...
function isHidden(element) {
  ...
  if (globalThis.getComputedStyle(element).display === "none") {
    return true;
  }

  let parent = element.parentElement;
  while (parent) {
    if (globalThis.getComputedStyle(parent).display === "none") {
      return true;
    }
...
globalThis.addEventListener("resize", calArrowPos);

// Tính toán lại vị trí arrow sau khi tải template
globalThis.addEventListener("template-loaded", calArrowPos);
 ...
 */
globalThis.addEventListener("template-loaded", handleActiveMenu);
...
globalThis.addEventListener("template-loaded", () => {
